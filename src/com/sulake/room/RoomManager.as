package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_797:XML = null;
      
      private var _state:int = 0;
      
      private var var_120:IRoomManagerListener;
      ...
      private var var_463:IRoomObjectFactory = null;
      
      private var var_1398:int;
      
      private var var_2252:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_462 = [];
         var_438 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_396,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_459,onContentLoaded);
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_463.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_463 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_438.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
         var_438.splice(_loc2_,1);
         var _loc3_:int = -1;
         while(_loc3_ >= 0)
         {
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_463 != null)
         {
            return var_463.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_120 != null)
            {
               var_120.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(var_120 != null)
            {
               var_120.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(var_120 != null)
         {
            var_120.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_51.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(false)
            {
               ...
               if(var_120 != null)
               {
                  var_120.roomManagerInitialized();
               }
            }
         }
         else
         {
            _state = const_590;
            var_120.roomManagerInitialized(false);
         }
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_463.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(var_120 != null)
                                 {
                                    var_120.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
