package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_723:RoomObjectLocationCache;
      ...
      private var var_1640:Number = -10000000;
      
      private var var_1639:Number = -10000000;
      ...
      private var var_911:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_723 = new RoomObjectLocationCache(_loc6_);
         var_281 = new Map();
      ...
      public function update() : void
      {
         if(var_914 == 0)
         {
            checkMouseHits(var_912.x,var_912.y,MouseEvent.MOUSE_MOVE);
         }
         var_914 = 0;
         ++var_1331;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_248 != null)
         {
            var_248.graphics.clear();
         }
         else
         {
            var_248 = new Sprite();
            var_248.name = "mask";
            _master.addChild(var_248);
         }
         var_248.graphics.beginFill(0);
         var_248.graphics.drawRect(0,0,param1,param2);
         var_913 = param1;
         var_910 = param2;
         var_55.graphics.clear();
         var_55.graphics.beginFill(var_20);
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - var_910 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc8_ < var_125.length)
         {
            var_125.splice(_loc8_);
         }
         _loc3_ = getTimer();
         ErrorReportStorage.addDebugData("Canvas rendering split time","Canvas render split: " + (_loc3_ - _loc2_));
         var _loc12_:String = " ";
         ...
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorting sprites" + _loc12_ + var_125.length);
         var_125.sortOn("z",0 | 0);
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorted sprites" + _loc12_ + var_125.length);
         var _loc13_:* = null;
         var _loc14_:int = 0;
         _loc7_ = 0;
         while(_loc7_ < _loc8_)
         {
            _loc13_ = var_125[_loc7_] as SortableSprite;
            updateSprite(_loc7_,_loc13_);
            _loc13_.bitmapData = null;
            _loc7_++;
         }
         cleanSprites(var_125.length);
         var_1638 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_429 != null)
         {
            ...
            {
               cleanSprite(var_429[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_429 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_281 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < var_281.length)
         {
            _loc2_ = var_281.getKey(_loc1_);
            _loc3_ = var_281.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_911 != null)
                  {
                     var_911.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1331,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_125.length)
         {
            return null;
         }
         return var_125[param1] as SortableSprite;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(var_281 != null && param1 != null)
         {
            var_281.add(param2,param1);
         }
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_430.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_430.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1640 || param2 != var_1639)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_430.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_430.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_429.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         var _loc3_:ExtendedSprite = var_55.getChildAt(param1) as ExtendedSprite;
         if(_loc3_ != null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int) : int
      {
         ...
         var _loc6_:IVector3d = var_723.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc7_ += int(var_913 / 2);
         _loc8_ += int(var_910 / 2);
         var _loc10_:int = 0;
         var _loc11_:* = null;
         var _loc12_:* = null;
         var _loc13_:int = 0;
            ...
            if(_loc12_ != null && _loc12_.visible)
            {
               ...
               if(_loc16_ != null)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     ...
                     if(_loc13_ + _loc18_.width >= 0 && _loc13_ < var_913 && (_loc14_ + _loc18_.height >= 0 && _loc14_ < var_910))
                     {
                        if(param3 + _loc10_ < var_125.length)
                        {
                           _loc11_ = var_125[param3 + _loc10_];
