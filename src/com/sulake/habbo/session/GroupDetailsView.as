   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(var_158 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_158 = _sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_283,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
