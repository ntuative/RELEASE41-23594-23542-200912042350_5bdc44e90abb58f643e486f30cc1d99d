package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1009:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_320 && _connection != null)
         {
      ...
      {
         return var_1009 as IUserDataManager;
      }
