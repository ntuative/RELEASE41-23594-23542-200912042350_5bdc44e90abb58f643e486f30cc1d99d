package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1421.visible = true;
         var_1894.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_651.setText(param1.eventDescription);
         var_790.setText(getTagFromEvent(param1,1));
         var_789.setText(getTagFromEvent(param1,2));
         var_1186.visible = false;
         var_1187.visible = true;
         var_1185.visible = true;
         var_1422.visible = false;
         var_1420.visible = true;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1421 = IWindowContainer(find("event_type_disabled_cont"));
            var_1894 = ITextWindow(find("event_type_disabled_text"));
            var_1422 = ITextWindow(find("create_caption"));
            var_1420 = ITextWindow(find("edit_caption"));
            var_1186 = IButtonWindow(find("create_button"));
            var_1187 = IButtonWindow(find("edit_button"));
            var_1893 = IButtonWindow(find("cancel_button"));
            var_1185 = IButtonWindow(find("end_button"));
            var_788 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1186,onCreateButtonClick);
            Util.setProcDirectly(var_1187,onEditButtonClick);
            Util.setProcDirectly(var_1185,onEndButtonClick);
            Util.setProcDirectly(var_1893,onCancelButtonClick);
            ...
            var_790 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
