package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1802 = new RoomThumbnailRenderer(param1);
         var_882 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_172,var_116.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_882.refreshTags(_loc1_,var_116.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1802.refreshThumbnail(_loc1_,var_116.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_172,var_116);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_172,!true ? getEventCtg(var_116.categoryId) : getRoomCtg(var_116.categoryId));
         refreshRoomDesc(var_172,var_116);
         refreshExtraCont();
         refreshInfo(var_172,"trading_allowed",var_116.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_204,Tabs.const_217,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
