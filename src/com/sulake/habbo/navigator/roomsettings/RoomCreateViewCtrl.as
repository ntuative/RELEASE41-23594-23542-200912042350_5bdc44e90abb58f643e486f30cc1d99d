package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_770:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1164 = new Timer(100);
         var_1164.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_66 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_962 = new TextFieldManager(_navigator,ITextFieldWindow(var_33.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_962.getText();
      ...
      {
         var_962.goBackToInitialState();
         var_962.input.textBackgroundColor = 4294967295;
         var_770 = var_66[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_962.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_770.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1165 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1165 = true;
            _loc3_.y = 1;
