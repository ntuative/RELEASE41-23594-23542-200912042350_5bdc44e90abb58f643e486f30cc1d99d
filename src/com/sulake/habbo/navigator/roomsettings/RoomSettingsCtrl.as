package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_391:IRoomSettingsCtrlOwner;
      
      private var _inRoom:Boolean;
      
      private var var_1190:TextFieldManager;
      ...
      private var var_1194:ICheckBoxWindow;
      ...
      private var var_1429:ITextWindow;
      ...
      {
         close();
         this.var_391.roomSettingsRefreshNeeded();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_391.roomSettingsRefreshNeeded();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_392);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_79.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_392]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1430.visible = _inRoom;
         var_1431.visible = _inRoom;
         var_1899.visible = var_461;
         var_1900.visible = !var_461;
         if(var_461)
         {
            var_978.visible = true;
            var_1189.visible = false;
            refreshFlatControllers();
            var_978.height = Util.getLowestPoint(this.var_978) + 4;
         }
         else
         {
            populateForm();
            var_977.visible = true;
            var_1189.visible = true;
            var_1192.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1192.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_977.height = Util.getLowestPoint(this.var_977) + 4;
         }
         var_1429.text = !!var_461 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1430.name,var_1192.name,var_977.name,var_978.name,var_1189.name,var_1431.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         var_795.setText(_loc1_.name);
         var_1190.setText(_loc1_.description);
         var_976.setText("");
         var_1193.setText("");
      ...
      {
         this.var_392 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_392));
         if(var_979 != null)
         {
            var_979.visible = false;
         }
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_795.getText();
         _loc2_.description = var_1190.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_359;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_122)
         {
            _loc8_ = var_976.getText();
         ...
         _loc2_.allowPets = var_1191.isSelected;
         _loc2_.allowFoodConsume = var_1194.isSelected;
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_392));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_392 || var_975 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_975 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1167)
         {
            this.var_795.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1197)
         {
            this.var_795.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1318)
         {
            this.var_1190.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         {
            this.var_976.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_795.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_891,onDoorModePasswordUnselect);
         ...
         refreshCategories();
         this.var_795 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1190 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_790 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_789 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_976 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1193 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1191 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1194 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         var_1430 = IWindowContainer(_window.findChildByName("header_container"));
         var_1192 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_977 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_978 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1431 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1189 = IWindowContainer(_window.findChildByName("footer_container"));
         var_259 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_979 = IWindowContainer(_window.findChildByName("password_container"));
         var_1900 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1899 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1429 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1429.procedure = onSwitchView;
         var_979.visible = false;
         if(!_inRoom)
         {
