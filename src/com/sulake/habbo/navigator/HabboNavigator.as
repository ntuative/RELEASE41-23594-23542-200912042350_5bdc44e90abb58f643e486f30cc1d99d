package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2263:Dictionary;
      ...
      private var var_2094:ISessionDataManager;
      
      private var var_2095:RoomCreateViewCtrl;
      
      private var var_1802:RoomThumbnailRenderer;
      
      private var var_203:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1267:RoomInfoViewCtrl;
      
      private var var_70:IHabboCatalog;
      
      private var var_365:Tabs;
      
      private var var_482:MainViewCtrl;
      
      private var var_2093:Array;
      
      private var var_976:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_482 = new MainViewCtrl(this);
         var_1267 = new RoomInfoViewCtrl(this);
         var_2095 = new RoomCreateViewCtrl(this);
         var_1802 = new RoomThumbnailRenderer(this);
         var_976 = new GuestRoomPasswordInput(this);
         var_338 = new GuestRoomDoorbell(this);
         var_365 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_482.startSearch(Tabs.const_204,Tabs.const_300,param1);
         var_482.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_203 != null)
         {
            var_203.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_203 != null)
         {
            var_203.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_203.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2094 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_482.startSearch(Tabs.const_261,Tabs.const_198);
         var_365.getTab(Tabs.const_261).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_482.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
