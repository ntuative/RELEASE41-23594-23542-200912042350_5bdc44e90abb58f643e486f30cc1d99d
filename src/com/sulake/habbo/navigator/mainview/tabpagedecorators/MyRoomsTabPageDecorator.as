package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_480:IDropMenuWindow;
      
      private var var_2262:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         return Tabs.const_198;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_480 == null ? 0 : int(var_480.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_261,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_480 == null)
         {
            var_480 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_480.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
