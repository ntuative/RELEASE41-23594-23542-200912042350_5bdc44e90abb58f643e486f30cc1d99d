package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1093:int = 70;
      ...
      private var var_1836:UserCountRenderer;
      ...
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1836 = new UserCountRenderer(_navigator);
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_204,Tabs.const_300,_loc2_.tag);
         }
         ...
         else if(_loc2_.flatCategoryId > 0)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_268,Tabs.const_467,"" + _loc2_.flatCategoryId,MainViewCtrl.const_573);
         }
         else
         {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_647 || param2.type == OfficialRoomEntryData.TYPE_PUBLIC_SPACE))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_1836.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
