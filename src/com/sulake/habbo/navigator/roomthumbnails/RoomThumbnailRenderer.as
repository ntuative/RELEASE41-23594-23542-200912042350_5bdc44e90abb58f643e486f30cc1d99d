package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1040:int = -16;
      
      private static const const_737:int = 32;
      
      private static const const_1042:int = 8;
      ...
      private var var_756:ThumbnailImageConfigurations;
      
      private var var_1146:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_951 = new Dictionary();
         super();
         _navigator = param1;
         var_756 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_40,0 | (!!param3 ? HabboWindowParam.const_35 : HabboWindowParam.const_40),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_756.getImage(ThumbnailEditorModel.const_31,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1040,_loc4_.y + const_1041 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1785[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_756.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_756.getImage(ThumbnailEditorModel.const_36,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_756.getImage(ThumbnailEditorModel.const_51,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_737 / 2);
         return new Point(param1 * const_737 + _loc3_,param2 * const_1042);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_362)
         {
            if(false)
            {
               refreshObj(param1,var_951[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1146 == null)
         {
            var_1146 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1146,var_1146.rect,new Point(0,0),null,null,true);
      }
   }
}
