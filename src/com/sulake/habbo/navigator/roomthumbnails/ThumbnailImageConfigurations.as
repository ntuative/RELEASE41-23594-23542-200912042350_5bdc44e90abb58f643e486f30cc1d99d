package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfigurations
   {
      ...
      public function ThumbnailImageConfigurations(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         this.var_1615 = this._navigator.getButtonImage("rico_selected");
      ...
      {
         var _loc4_:ThumbnailImageConfiguration = new ThumbnailImageConfiguration(_navigator,param1,param2,param3,var_1615);
      ...
      {
         var _loc2_:Array = this.var_1364[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Array();
            var_1364[param1] = _loc2_;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1365[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1365[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
