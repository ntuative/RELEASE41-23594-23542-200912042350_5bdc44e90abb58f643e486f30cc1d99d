package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1474,this.var_92.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1475,this.var_92.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1474 = IButtonWindow(find("top_tab"));
         var_1475 = IButtonWindow(find("obj_tab"));
         var_2010 = IWindowContainer(find("tile_grid"));
         var_2009 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1474,onTopTabButton);
         Util.setProcDirectly(var_1475,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2010;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2009;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_65,new Rectangle(0,0,param1.width,66)));
