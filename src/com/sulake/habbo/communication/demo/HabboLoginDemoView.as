package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_708:String = "InitConnection";
      ...
      private var var_336:HabboCommunicationDemo;
      ...
      {
         var_336.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_336.shockwaveClientUrl = var_117.shockwaveClientUrl;
         var_336.ssoTicket = var_117.ticket;
         var_117.removeEventListener(SSOTicket.const_297,onParsedTicketSuccess);
         var_117.removeEventListener(SSOTicket.const_221,onParsedTicketFailure);
         var_117 = null;
         dispatchEvent(new Event(const_708));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1359,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_336 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_336.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_283,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_336.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1359,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_336.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_336.habboCommunication.habboWebLogin(name,password);
         var_117 = new SSOTicket(var_336.assets,_loc2_,_loc1_);
         var_117.addEventListener(SSOTicket.const_297,onParsedTicketSuccess);
         var_117.addEventListener(SSOTicket.const_221,onParsedTicketFailure);
      }
