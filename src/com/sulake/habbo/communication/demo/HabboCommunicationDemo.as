package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1934:PseudoRandom;
      ...
      private const const_1359:String = "fuselogin";
      
      private var var_598:ICoreCommunicationManager;
      
      private var var_467:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_328:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_854:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_953:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1935)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_659 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_659);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1215,var_1936));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1359,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_467.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_467.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1934);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1359,"/");
      ...
      {
         var_659 = _habboConfiguration.getKey("sso.ticket",null);
         var_1215 = _habboConfiguration.getKey("flash.client.url","");
         var_1936 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_176 == null)
         {
         ...
         if(var_659 != null)
         {
            var_81.mode = HabboConnectionType.const_420;
            var_81.initConnection(HabboConnectionType.const_233);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_81 = param2 as IHabboCommunicationManager;
            _loc3_ = var_81.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_81.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_81.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_81.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_81.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_81.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_81.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_81.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_81.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_81.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_81.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_81.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_81.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_81.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_502);
            _loc3_ = new InitCryptoMessageComposer(var_81.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1934 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_81.mode)
         {
            case HabboConnectionType.const_420:
               ...
               var_991 = _loc4_;
               var_176.loadBannerImage(_loc7_ + "?token=" + var_991,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1216:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1194:
               var_993 = generateRandomHexString(30);
               var_467 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_467.init(var_993);
               _loc8_ = var_467.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_991);
         ...
         var _loc9_:IConnection = var_81.getHabboMainConnection(null);
         ...
         var_467 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_993 = generateRandomHexString(30);
            var_467.init(var_993);
            _loc12_ = var_467.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_25,onConfigurationLoaded);
         }
      }
