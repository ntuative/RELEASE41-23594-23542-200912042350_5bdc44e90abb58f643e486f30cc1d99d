package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_823:uint = 0;
      
      private var var_668:IAssetLibrary;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_668.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_668.getAssetByName(_loc2_.assetName);
         if(param1.type == AssetLoaderEvent.const_48)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_57));
            }
         }
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_445));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_668.loadAssetFromFile("hotel_view_banner_" + var_823,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_561));
            }
            var_185 = param2;
