package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomSessionChatEvent.const_133];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_487 != null)
         {
            ...
            {
               _loc2_ = var_487.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_133:
               _loc3_ = param1 as RoomSessionChatEvent;
               if(_loc3_ != null)
               {
                  _loc4_ = _container.roomEngine.getRoomObject(_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.userId,RoomObjectCategoryEnum.const_37);
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_487.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_691.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_304:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_102);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_102);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_487.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_691.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
                        ...
                        _loc14_ = "null";
                        _loc2_ = new RoomWidgetChatUpdateEvent(_loc14_,_loc3_.userId,_loc3_.text,_loc11_,RoomObjectCategoryEnum.const_37,_loc6_,_loc7_,_loc13_,_loc12_,_loc3_.session.roomId,_loc3_.session.roomCategory,_loc3_.chatType);
                     }
                  }
               }
         }
      ...
      {
         return [RoomWidgetChatMessage.const_525,RoomWidgetChatSelectAvatarMessage.const_616];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_525:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_133,_container.roomSession,0,"Version 23594-23542-200912042316");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_323);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_408);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_616:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_856 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_856);
            }
            if(var_488 == null)
            {
               var_486.x = 0;
               var_486.y = 0;
               var_486.z = 0;
               var_488 = _loc4_.getScreenPoint(var_486);
               var_856 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_486.x = 0;
            var_486.y = 0;
            var_486.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_486);
            if(_loc8_ != null)
            {
