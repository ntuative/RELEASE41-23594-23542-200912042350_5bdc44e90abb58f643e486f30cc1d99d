package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1565:String = "room_widget";
      
      private const const_1572:String = "room_desktop_layout_container";
      
      private const const_1058:String = "room_view";
      
      private var var_647:int = 50;
      
      private var var_2195:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_67.getChildByTag(const_1058) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_67.findChildByTag(const_1058) as IWindowContainer;
         if(_loc1_ != null)
         {
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_647;
               _loc2_.width = var_67.desktop.width - var_647;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_647;
               _loc2_.height = var_67.desktop.height - var_647;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_67.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_67.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_285,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1565) == 0)
            {
