package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private var var_961:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_961 = param2;
         var_539 = new Timer(const_1044);
         var_539.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_452.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_452.splice(_loc3_,1);
            var_451.splice(_loc3_,1);
         }
         var_451.push(param1.name);
         var_452.push(param2);
         param1.addEventListener(WindowEvent.const_389,windowEventListener);
         param1.addEventListener(WindowEvent.const_205,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_452[var_451.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_961.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_961.getIconLoc(param1.iconId);
      ...
      {
         return var_451[var_452.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_538[_loc3_] = new Array();
            }
            if(var_538[_loc3_].indexOf(param1) < 0)
            {
               var_538[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_746 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_746 || param1.desktop.height - param1.y < const_1052;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_451.length)
         {
            if(var_451[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_538[_loc3_].length)
                  {
                     repositionWindow(var_538[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
