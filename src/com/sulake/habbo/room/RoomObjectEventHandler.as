package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_721);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_935);
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_511);
         }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_449:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1337));
               break;
            case RoomObjectFurnitureActionEvent.const_446:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_855));
         }
      }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_33 || _loc5_ == RoomObjectCategoryEnum.const_37)
               {
                  _loc7_ = _loc11_.x;
                  _loc8_ = _loc11_.y;
               }
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_37 && _loc3_.typeId == RoomObjectTypeEnum.const_304)
               {
         ...
         {
            _roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_210,param1,param2,_loc4_,_loc5_));
         }
         resetSelectedObjectData(param1,param2);
      }
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_33:
            case RoomObjectCategoryEnum.const_29:
               if(param4 == RoomObjectCategoryEnum.const_37)
               {
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_549,param1,param2,param3,param4));
         }
      }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_37 && _loc8_ != null)
            {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_33)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_511);
         ...
         if(_loc6_ != null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_37)
            {
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc8_ == RoomObjectCategoryEnum.const_37)
                  {
                     if(_loc10_ != null)
                     {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_60)
         {
            ...
            if(_loc12_ != _loc10_)
            {
               ...
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_466,param2,param3,-1,RoomObjectCategoryEnum.const_216));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
         ...
         if(_roomEngine != null && false)
         {
            switch(param5)
            {
               ...
               case RoomObjectFurnitureActionEvent.const_400:
                  ...
                  break;
               case RoomObjectFurnitureActionEvent.const_369:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectMouseEvent.const_463:
               ...
               break;
            case RoomObjectMouseEvent.const_418:
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:IRoomObjectController = _roomEngine.getRoomObject(param1,param2,var_955,_loc5_) as IRoomObjectController;
         ...
         if(_loc8_ != null && _loc8_.getEventHandler() != null)
         {
            if(_loc7_)
            {
               _loc8_.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_393));
            }
            else
            {
               _loc8_.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_471));
            }
         }
      }
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_421:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_365:
         ...
         if(_roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc8_.getEventHandler().processUpdateMessage(_loc10_);
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_393);
               }
               else
               {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_235:
            ...
            case RoomObjectRoomAdEvent.const_305:
               ...
               break;
            case RoomObjectRoomActionEvent.const_421:
            case RoomObjectRoomActionEvent.const_874:
            case RoomObjectRoomActionEvent.const_365:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_377:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_900));
               break;
            case RoomObjectFurnitureActionEvent.const_382:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1223));
               break;
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_DISPOSE:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_855));
         }
