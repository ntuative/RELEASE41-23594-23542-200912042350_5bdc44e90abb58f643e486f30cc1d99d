package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_766:String = "selection_arrow";
      
      private static const const_765:String = "tile_cursor";
      ...
      private static const const_1095:String = const_342;
      ...
      public static const const_620:String = "RCL_LOADER_READY";
      ...
      public function RoomContentLoader()
      {
         var_694 = [];
         var_695 = [];
         var_2120 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2121 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_410 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_571.getValue(param1) as String;
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_110 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_181 != null && var_181.hasWorldType(const_272 + param1))
         {
            return var_181.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_694.indexOf(_loc14_) < 0)
                              {
                                 var_694.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_571.add(_loc10_,_loc11_);
                              if(var_695.indexOf(_loc14_) < 0)
                              {
                                 var_695.push(_loc14_);
                              }
                           }
                           _loc16_ = var_489.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_489.remove(_loc14_);
                              var_489.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_410 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_410.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return [const_342,const_489,ROOM_CONTENT,const_765,const_766];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_410.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_410.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2120.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_168 && _loc5_ != RoomObjectLogicEnum.const_110)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_694.indexOf(param1) >= 0)
         {
            return const_342;
         }
         if(var_695.indexOf(param1) >= 0)
         {
            return const_489;
         }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1191);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_571.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2121.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_459,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(param1 == "user")
         {
            return RoomObjectCategoryEnum.const_37;
         }
         if(param1 == "pet")
         {
            return RoomObjectCategoryEnum.const_37;
      ...
      private function continueInitilization() : void
      {
         if(var_2122)
         {
            ...
            if(var_1026 != null)
            {
               var_1026.dispatchEvent(new Event(const_620));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_181 != null)
         {
            return var_181.getWorldHeightScale(const_272 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1026 = param1;
            var_2123 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2119 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2118 = param2.getKey("public.room.dynamic.download.url","");
            var_2124 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_767;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_168 && _loc5_ != RoomObjectVisualizationEnum.const_110)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_272 + param1) == RoomObjectCategoryEnum.const_60)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_419,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_181 != null)
         {
            return var_181.getWorldScale(const_272 + param1);
         }
         return 32;
      }
