package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2151:Number = NaN;
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc6_ < spriteCount - 1)
                  {
                     ...
                     _loc10_.color = getSpriteColor(_loc6_,var_2150,param1);
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2150 = _loc3_.getNumber(RoomObjectVariableEnum.const_215);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_276 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2151)
         {
