package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_797);
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_218 != null)
         {
            ...
            {
               _loc2_ = var_218[_loc3_];
               _loc2_.update(var_520,var_1714,param1);
               _loc3_++;
            }
