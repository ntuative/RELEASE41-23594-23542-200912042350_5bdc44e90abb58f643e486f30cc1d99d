package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1366:int = 0;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_157);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_630);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_633);
         ...
         var _loc13_:Number = _loc7_ - var_1231;
         ...
         if(_loc19_ || _loc20_)
         {
            ...
            if(_loc5_ == null)
            {
               _loc5_ = var_731.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_286);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_231) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_231);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_668);
            _loc5_.method_1(AvatarAction.const_637,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_457);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_343);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.method_1(AvatarAction.const_277,AvatarAction.const_1117[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_919);
            if(_loc29_ > 0)
            {
               _loc5_.method_1(AvatarAction.const_783,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_872);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_838);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.method_1(AvatarAction.const_805,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_639);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_680);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.method_1(AvatarAction.const_892,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_773);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.method_1(AvatarAction.const_814,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.method_1(AvatarAction.const_361);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_370) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.method_1(AvatarAction.const_601);
            }
            if(_loc14_)
            {
               _loc5_.method_1(AvatarAction.const_397);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_907);
            if(_loc35_ > 0)
            {
               _loc5_.method_1(AvatarAction.const_664,_loc35_);
            }
            ...
            for each(_loc47_ in _loc5_.getSprites())
            {
               ...
               {
                  _loc42_ = getSprite(const_1366);
                  _loc61_ = _loc5_.method_2(_loc47_);
               ...
               else
               {
                  ...
                  if(_loc42_ != null)
                  {
                     ...
                     _loc64_ = _loc5_.method_2(_loc47_);
                     _loc65_ = 0;
            ...
            _loc42_ = getSprite(const_1550);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_975))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_731.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_730.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_730)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
