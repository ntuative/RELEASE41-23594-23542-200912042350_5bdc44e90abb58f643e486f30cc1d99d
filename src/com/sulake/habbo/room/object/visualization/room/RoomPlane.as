package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         var_271.assign(param4);
         var_400 = Vector3d.crossProduct(var_270,var_271);
         if(false)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_266 || _type == const_175))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_835 || false && false && !var_159 || var_554 == null)
         {
            return;
         }
         ...
         if(var_159)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_400);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_202.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_554.updateMask(var_63,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_676.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
      ...
      {
         if(var_140 == null || var_110 == null || var_86 == null || var_111 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_266 || _type == const_175)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            while(_loc1_ < var_202.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < var_676.length)
                  {
                     _loc7_ = var_676[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      {
         var_140.assign(param1.getScreenPosition(var_77));
         var_110.assign(param1.getScreenPosition(Vector3d.sum(var_77,var_271)));
         var_86.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_77,var_270),var_271)));
         var_111.assign(param1.getScreenPosition(Vector3d.sum(var_77,var_270)));
         _offset = param1.getScreenPoint(var_677);
         ...
         var _loc2_:Number = Math.min(var_140.x,var_110.x,var_86.x,var_111.x);
         var _loc3_:Number = Math.max(var_140.x,var_110.x,var_86.x,var_111.x);
         var _loc4_:Number = Math.min(var_140.y,var_110.y,var_86.y,var_111.y);
         var _loc5_:Number = Math.max(var_140.y,var_110.y,var_86.y,var_111.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_140.x = 0 - _loc2_;
         var_110.x = 0 - _loc2_;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc10_:* = null;
         if(param1 == null || var_677 == null || var_77 == null || var_270 == null || var_271 == null || var_400 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1253)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1019 || _loc4_.y != var_2034 || _loc4_.z != var_2039 || param1.scale != var_2035))
            {
               var_1019 = _loc4_.x;
               var_2034 = _loc4_.y;
               var_2039 = _loc4_.z;
               ...
               _loc6_ = 0;
               while(_loc6_ < var_1252.length)
               {
                  _loc5_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1252[_loc6_]));
                  if(_loc5_ > -0.001)
                  {
                     if(_isVisible)
                     {
               ...
               _loc7_ = param1.getScreenPosition(var_677);
               _loc8_ = _loc7_.z;
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc4_:PlaneBitmapData = var_177.getValue(_loc3_) as PlaneBitmapData;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc4_ = var_177.getValue(_loc3_) as PlaneBitmapData;
            _loc8_ = null;
            if(_loc4_ != null)
            {
            ...
            if(var_678 != null)
            {
               _loc4_ = var_678.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1479,var_2038,var_2036,var_2037,var_2031,param2);
               if(_loc4_ != null)
               {
