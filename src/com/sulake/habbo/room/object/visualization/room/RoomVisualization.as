package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1085:int = 16777215;
      
      public static const const_1189:int = 10066329;
      ...
      public static const const_1163:int = 16777215;
      
      private static const const_1084:int = 10066329;
      
      private static const const_1083:int = 10066329;
      
      public static const const_1272:int = 13421772;
       
      
      private var var_1058:String = null;
      ...
      private var var_2029:String = null;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1391;
               }
               if(var_85.getPlaneType(_loc4_) == RoomPlaneData.const_142)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_85.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_254)
            {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_266 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         if(var_183 != _loc3_.getUpdateID())
         {
            ...
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_558);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_615);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_942);
            if(_loc8_ != var_2029)
            {
               updatePlaneMasks(_loc8_);
               var_2029 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_720));
            if(_loc9_ != var_1017)
            {
               var_1017 = _loc9_;
            }
            var_2030 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_841));
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_175)
            {
               _loc12_ = uint(_loc11_.color);
               if(var_2030)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_1017 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_1017 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_1017 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_881);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_889);
         var _loc7_:int = 0;
         while(_loc7_ < var_85.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_173,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_266,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_254)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_175,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1163;
               }
               else if(_loc14_.y == 0)
               {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_109.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_173 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_266 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_175 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_109.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_266 || _loc3_.type == RoomPlane.const_175 && _loc8_ == RoomPlaneBitmapMaskData.const_214)
                  {
