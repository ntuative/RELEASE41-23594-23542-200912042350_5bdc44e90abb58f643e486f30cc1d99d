package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1907:BitmapData = null;
      ...
      private var var_1908:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_469,0,0,_loc4_,var_1438,var_1908,var_1907));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1905 = int(_config.getKey("interstitial.interval","30000"));
         var_1904 = int(_config.getKey("interstitial.show.time","5000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1201 = _loc2_.imageUrl;
         var_1438 = _loc2_.clickUrl;
         if(var_1201 != "" && var_1438 != "")
         {
            _loc3_ = var_1201;
            ...
            _loc4_ = new URLRequest(var_1201);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1202 = _loc2_.imageUrl;
         var_1906 = _loc2_.clickUrl;
         var_654 = getTimer();
         if(var_1202 != "")
         {
            _loc3_ = var_1202;
            ...
            var_230.start();
            _loc4_ = new URLRequest(var_1202);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_430,0,0,param1.bitmapData,var_1906));
            var_654 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1907 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         var _loc1_:int = getTimer() - var_654;
         if(_loc1_ > var_1905)
         {
            ++var_1440;
      ...
      {
         var_598 = param2 as IHabboCommunicationManager;
         if(var_598 == null)
         {
            return;
         }
         _connection = var_598.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1908 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
