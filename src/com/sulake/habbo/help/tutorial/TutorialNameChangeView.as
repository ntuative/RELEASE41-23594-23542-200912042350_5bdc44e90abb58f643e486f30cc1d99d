package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1382:uint = 13232628;
      
      private static var var_1799:uint = 11129827;
      ...
      private var var_760:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_56.localization.registerParameter("help.tutorial.name.available","name",var_379);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_ok":
                  ...
                  break;
               case "button_cancel":
                  var_56.showView(TutorialUI.const_81);
                  break;
               case "button_usecurrent":
                  var_379 = var_56.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_56.localization.registerParameter("help.tutorial.name.confirmation","name",var_379);
         }
         if(var_253 == null)
         {
            var_253 = var_56.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_253 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_760 = new NameSuggestionListRenderer(var_56);
         var _loc6_:int = var_760.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1382;
