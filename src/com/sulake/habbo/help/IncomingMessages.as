package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_42.tellUI(HabboHelpViewEnum.const_186,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_42.tellUI(HabboHelpViewEnum.const_220,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_42.tellUI(HabboHelpViewEnum.const_139);
      }
      ...
      {
         var_42.showUI(HabboHelpViewEnum.const_311);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_42.showUI(HabboHelpViewEnum.const_381);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_42.showUI(HabboHelpViewEnum.const_695);
         var_42.tellUI(HabboHelpViewEnum.const_695,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_473)
            {
         ...
         var_42.tellUI(HabboHelpViewEnum.const_581);
      }
