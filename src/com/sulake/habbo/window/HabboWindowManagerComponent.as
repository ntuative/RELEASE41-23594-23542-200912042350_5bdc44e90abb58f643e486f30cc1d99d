package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_334:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1004:uint = 1;
      ...
      private var var_1066:ProfilerAgentTask;
      
      private var var_1064:IEventDispatcher;
      
      private var var_2236:uint = 0;
      
      private var var_1067:ProfilerAgentTask;
      
      private var var_1065:ProfilerOutput;
      
      private var var_594:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1064 = Component(param1).events;
            var_710 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_594 = new WindowRenderer(_loc4_);
         var_277 = new Array(const_334);
         var _loc6_:int = 0;
         while(_loc6_ < const_334)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_594,this,_localization,var_189,new Rectangle(0,0,var_189.stageWidth,var_189.stageHeight),this);
            var_277[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_357 = var_277[const_1004];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_357.getMouseCursor().defineCustomCursorType(MouseCursorType.const_278,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_357.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1202,_loc7_);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1065 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1065 = new ProfilerOutput(_loc3_,this,var_594);
               var_1066 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1066);
               var_1067 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1067);
               var_889 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_858.length > 0)
         {
            var_1064.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_334 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1064.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_334)
         {
         ...
         if(WindowContext.var_858.length > 0)
         {
            WindowContext.var_858.flush();
         }
         if(WindowContext.var_1285.length > 0)
         {
            WindowContext.var_1285.flush();
         }
         var_1064.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_710[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_710[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1112,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1129,new Date().getTime().toString());
