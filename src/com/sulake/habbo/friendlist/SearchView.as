package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_696:ITextFieldWindow;
      ...
      {
         var_696 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_696.procedure = onSearchInput;
         var_696.addEventListener(WindowKeyboardEvent.const_141,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            _list.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_321,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_696.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
