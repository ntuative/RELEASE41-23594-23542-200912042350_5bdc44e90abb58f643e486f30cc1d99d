package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_162:String = "face";
       
      
      private var _view:FriendListView;
      
      private var var_1775:IAvatarRenderManager;
      
      private var var_1410:AvatarSearchResults;
      
      private var var_139:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_780:FriendRequests;
      
      private var var_1866:int;
      
      var var_311:FriendCategories;
      
      private var var_203:IHabboToolbar;
      
      private var var_1868:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_365:FriendListTabs;
      
      private var var_1867:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1411:OpenedToWebPopup;
      ...
      {
         var_1868 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_311 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1410 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1411 == null)
         {
            var_1411 = new OpenedToWebPopup(this);
         }
         var_1411.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_780.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_780.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_365.findTab(FriendListTab.const_97).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_780.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_203.events.dispatchEvent(_loc1_);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_311.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_780 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_311.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_311.addCategory(new FriendCategory(FriendCategory.const_944,getText("friendlist.friends")));
         var_311.addCategory(new FriendCategory(FriendCategory.const_350,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_311.addFriend(new Friend(_loc4_));
         }
         var_365 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_203.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_311.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1775.createAvatarImage(param1,AvatarScaleType.const_102);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1775 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_780.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_365.findTab(FriendListTab.const_97);
      ...
      {
         var_1867 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_311.getFriendCount(param1,param2);
      }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "UseObjectMessageEvent";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_365.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         var_203 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1410.searchReceived(_loc2_.friends,_loc2_.others);
