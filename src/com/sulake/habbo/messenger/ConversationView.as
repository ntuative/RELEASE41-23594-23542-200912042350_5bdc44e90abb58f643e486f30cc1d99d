package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1025:int = 10;
      
      private static const const_1024:int = 20;
      
      private static const const_732:int = 100;
       
      
      private var var_1686:IScrollbarWindow;
      
      private var var_139:HabboMessenger;
      
      private var var_1337:IContainerButtonWindow;
      
      private var var_432:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_139 = param1;
         var_1337 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1686 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_692 || param3.type == Message.const_604 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_432.messages.length - const_732);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_432.messages.length)
         {
            refreshEntry(true,_loc1_,var_432.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_432 == null || _loc1_.id != var_432.id)
         {
            var_432 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_732 + const_1024)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_139.send(new FollowFriendMessageComposer(var_432.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1025;
         param1.invalidate();
      }
   }
}
