package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_372:PartSetsData;
      
      private var var_1704:PartOffsetData;
      ...
      private var var_1342:AvatarStructureDownloadSet;
      
      private var var_737:AvatarActionManager;
      
      private var var_150:IAssetLibrary;
      
      private var var_434:FigureData;
      
      private var var_2179:IAssetLibrary;
      
      private var var_1300:Boolean = false;
      
      private var var_610:AnimationManager;
      
      private var var_1705:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_150 = param2;
         var_2179 = param3;
         var_434 = new FigureData();
         var_372 = new PartSetsData();
         _animationData = new AnimationData();
         var_1342 = new AvatarStructureDownloadSet();
         var_610 = new AnimationManager();
         var_736 = param4;
         var_1704 = PartOffsetData.getInstance(param3);
      }
      
      public function getBodyParts(param1:String, param2:IActionDefinition, param3:int) : Array
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1243[param3];
      ...
      {
         return var_737.getActionDefinitionWithState(param1);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_610.getAnimation(param1);
      }
      ...
      public function init(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_736)
         {
            case AvatarType.const_92:
               _loc3_ = var_150.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_372.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_150.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_150.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_434.parse(_loc5_))
               {
                  return;
               }
               var_1342.add(new AvatarStructureDownload(var_150,_loc2_,var_434));
               _loc6_ = true;
               break;
            case AvatarType.PET:
               _loc3_ = var_150.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_372.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_150.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_150.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_434.parse(_loc5_))
               {
                  return;
               }
         ...
         if(_loc6_)
         {
            var_1342.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
         }
         else
         {
            onStructureReady();
      ...
      {
         return var_737.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_737.getActionDefinition(param1);
      }
      
      private function initActions() : void
      {
         var_737 = new AvatarActionManager(var_150,var_736);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_610.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_372.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_372.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_737.getDefaultActionType();
         var _loc7_:Array = var_372.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_610.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_434.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_434.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_372.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_372.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_92:
               if(var_150.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_150.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_150.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_150.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_150.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_150.getAssetByName("dance" + _loc1_).content as XML;
            var_610.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_150.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_150.getAssetByName("fx" + _loc1_).content as XML;
            var_610.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_434.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_434.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_736 + " ready to go!");
         if(var_736 == AvatarType.const_92)
         {
            var_372.getPartDefinition("ri").appendToFigure = true;
            var_372.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      {
         return var_737.sortActions(param1);
      }
   }
}
