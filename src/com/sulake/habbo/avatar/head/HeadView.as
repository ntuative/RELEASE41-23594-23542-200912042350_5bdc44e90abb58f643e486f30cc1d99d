package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_660["null"] = new AvatarEditorGridView(param1,FigureData.const_123,param2,param3);
         var_660["null"] = new AvatarEditorGridView(param1,FigureData.const_130,param2,param3);
         var_660["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_660["null"] = new AvatarEditorGridView(param1,FigureData.const_143,param2,param3);
         var_660["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         attachImages();
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1030);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_660[var_1333];
         if(_loc2_ == null)
         {
            return;
         }
