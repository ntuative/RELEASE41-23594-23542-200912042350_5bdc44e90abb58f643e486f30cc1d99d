package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1383:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         super();
         var_448 = new Matrix4x4();
         var_634 = new Dictionary();
         var_1383 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc4_ in param1.type)
         {
            ...
            var_634[String(_loc4_.@id)] = _loc12_;
         }
      }
      ...
      {
         var _loc5_:* = null;
         if(method_8(param1,param2))
         {
            _loc5_ = getBodyPartsOfType(param1)[param2] as GeometryBodyPart;
            var_448 = var_448.identity().rotateY(param3);
            return _loc5_.getParts(var_448,var_761,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1383.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function method_8(param1:String, param2:String) : Boolean
      {
         var _loc3_:* = null;
         if(typeExists(param1))
         {
            _loc3_ = var_634[param1] as Dictionary;
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = var_180[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_448 = var_448.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_448);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_634[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1383.findAvatarSet(param1);
         if(_loc3_ != null)
         {
