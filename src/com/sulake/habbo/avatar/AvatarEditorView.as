package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1510:IWindowContainer;
      
      public static var var_1286:IWindowContainer;
      
      public static var var_1030:int = 6710886;
      ...
      private var var_1419:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1510 == null)
         {
            ...
            var_1510 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_684 != null)
         {
            toggleCategoryView(var_684,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1419 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_684 = param1;
         var_1419.setSelected(var_1419.getSelectableByName(param1));
         _window.invalidate();
      }
