package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_875:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_875.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_877)
         {
            ...
            var_586["null"] = new FigureData(this);
            var_586["null"] = new FigureData(this);
            _loc1_ = var_586["null"];
            _loc2_ = var_586["null"];
            ...
            var_311 = new Map();
            var_311.add(AvatarEditorCategory.const_978,new GenericModel(this));
            var_311.add(AvatarEditorCategory.const_47,new HeadModel(this));
            var_311.add(AvatarEditorCategory.const_312,new TorsoModel(this));
            var_311.add(AvatarEditorCategory.const_1177,new LegsModel(this));
            var_311.add(AvatarEditorCategory.const_518,new WardrobeModel(this));
            var_877 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_311.getValue(AvatarEditorCategory.const_518);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_311.getValue(AvatarEditorCategory.const_518);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_875.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1510.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1169)
               {
                  _loc19_ = true;
               }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_311.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_357 == null)
            {
               var_357 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_357.addChild(_view.window);
               var_357.center();
               var_357.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_978);
         if(var_173 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1050 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_494,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_875 = var_1050.getFigureData(AvatarType.const_92);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_876 = param3;
         var _loc4_:FigureData = var_586[param2];
         if(_loc4_ == null)
         {
            return;
         }
