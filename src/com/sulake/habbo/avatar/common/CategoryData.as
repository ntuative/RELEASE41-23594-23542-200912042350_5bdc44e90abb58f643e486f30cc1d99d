package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_621 > -1)
         {
            return var_324[var_621] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_621 >= 0)
         {
            _loc3_ = var_324[var_621];
            _loc3_.isSelected = false;
         }
         if(var_324.length > param1)
         {
            _loc2_ = var_324[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_621 = param1;
