package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1388:String = "hot_looks";
      
      public static const const_1477:String = "my_looks";
      ...
      {
         var _loc2_:Outfit = var_157[param1];
         if(_loc2_ != null)
         {
            _loc2_.dispose();
         }
         var _loc3_:Outfit = new Outfit(_controller,_controller.figureData.method_5(),_controller.gender);
         var_157[param1] = _loc3_;
         if(false)
         {
