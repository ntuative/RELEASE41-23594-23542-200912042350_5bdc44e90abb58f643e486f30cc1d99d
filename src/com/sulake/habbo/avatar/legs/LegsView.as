package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_660["null"] = new AvatarEditorGridView(param1,FigureData.const_128,param2,param3);
         var_660["null"] = new AvatarEditorGridView(param1,FigureData.const_171,param2,param3);
         var_660["null"] = new AvatarEditorGridView(param1,FigureData.const_135,param2,param3);
         attachImages();
