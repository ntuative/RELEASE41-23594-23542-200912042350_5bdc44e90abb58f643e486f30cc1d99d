package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1373:int = 60000;
      ...
      private var var_801:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               else if(_loc15_.type == AnimationLayerData.const_391)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_75.getParts(param1,(var_801 as AvatarImage).getFigure(),_loc6_,var_1270,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_75.getCanvas(var_188,var_1270);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1104[param1])
            {
            ...
            _loc10_ = var_188 + "_" + _loc18_.assetPartDefinition + "_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_" + _loc13_;
            _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            if(_loc16_ == null)
            {
               _loc10_ = var_188 + "_std_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_0";
               _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            }
            if(_loc16_ == null)
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_908 || _loc32_ == AvatarAction.const_648) && (_loc6_ == AvatarBodyPartType.const_312 || _loc6_ == AvatarBodyPartType.const_1132 || _loc6_ == AvatarBodyPartType.const_1143) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_188 == AvatarScaleType.const_50)
            {
               _loc30_.x += 67;
            }
            else
