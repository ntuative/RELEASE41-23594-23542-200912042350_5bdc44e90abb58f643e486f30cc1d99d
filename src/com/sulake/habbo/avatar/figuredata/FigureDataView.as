package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_469:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1195 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_469 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_469.bitmap = new BitmapData(var_469.width,var_469.height,true,16777215);
         var_469.bitmap.copyPixels(var_1195,var_1195.rect,new Point(0,0 - 0 - 8));
         var_469.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
