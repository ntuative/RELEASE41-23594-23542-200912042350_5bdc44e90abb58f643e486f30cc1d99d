package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_670:PurchaseConfirmationDialog;
      
      private var var_838:IHabboSoundManager;
      
      private var var_345:ICatalogViewer;
      ...
      {
         return var_499.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_201.credits = _loc3_.balance;
         updatePurse();
         if(!var_2019 && var_838 != null)
         {
            var_838.playSound(HabboSoundTypesEnum.const_804);
         }
         var_2019 = false;
      }
      ...
      {
         return var_499.getFurnitureData(param1);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "UseObjectMessageEvent" == var_173.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               var_1243 = param1.session.isPrivateRoom;
               if(var_93 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_203.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_201.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_201.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_670 == null)
            {
               var_670 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_670.showOffer(this,param1,param2,param3,_loc7_);
         }
      }
      ...
      {
         var_203.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function method_11(param1:VoucherRedeemErrorMessageEvent) : void
      {
         if(param1 == null)
         {
            return;
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new VoucherRedeemErrorMessageEvent(method_11));
      ...
      {
         if(param1 == null || var_345 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_345.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_201.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2020 && var_838 != null)
         {
            var_838.playSound(HabboSoundTypesEnum.const_846);
         }
         var_2020 = false;
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_201.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_201.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_201.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_201.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_345.getCurrentLayoutCode();
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_345.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_345.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_345 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
