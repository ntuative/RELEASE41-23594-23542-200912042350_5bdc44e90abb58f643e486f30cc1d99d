package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1016:ITextFieldWindow;
      ...
      {
         super.init();
         var_1016 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1016 != null)
         {
            var_1016.addEventListener(WindowKeyboardEvent.const_830,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1016.text));
      }
   }
}
