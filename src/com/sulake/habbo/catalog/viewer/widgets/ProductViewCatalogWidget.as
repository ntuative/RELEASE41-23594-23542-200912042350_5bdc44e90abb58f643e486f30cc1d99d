package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1096:ITextWindow;
      
      private var var_1150:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_534 != null)
         {
            ...
            var_534.destroyGridItems();
         }
         if(var_1150 != null)
         {
            var_1150.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1096.text = "${" + _loc3_.name + "}";
            var_1097.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1096.text = "${" + _loc2_.localizationId + "}";
            var_1097.text = "${" + _loc2_.localizationId + "}";
         }
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_474:
                  ...
                  if(var_534 != null)
                  {
                     ...
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_534,var_1150,var_1299);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_275:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.method_1(AvatarAction.const_277,AvatarAction.const_498);
                              _loc13_.method_1(AvatarAction.const_664,_loc6_.productClassId);
                              ...
                              if(_loc11_ != null)
                              {
                                 ...
                                 for each(_loc18_ in _loc13_.getSprites())
                                 {
                                    ...
                                    {
                                       _loc19_ = _loc13_.method_2(_loc18_);
                                       _loc5_.x = _loc19_.dx;
                                       _loc5_.y = _loc19_.dy;
                                    }
                                 }
      ...
      {
         var_1096 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1097 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_91 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1381 = new Point(var_91.x,var_91.y);
         var_534 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1150 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_534 == null)
         {
         ...
         var_1149 = _loc2_.content as BitmapData;
