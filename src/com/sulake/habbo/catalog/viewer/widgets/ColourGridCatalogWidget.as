   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         for each(_loc1_ in var_1089)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_601.width,var_601.height,true,0);
               _loc3_.bitmap.copyPixels(var_601,var_601.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1090.width,var_1090.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_907.width,var_907.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_907,var_907.rect,new Point(0,0),null,null,true);
