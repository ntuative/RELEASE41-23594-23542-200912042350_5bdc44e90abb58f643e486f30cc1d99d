package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_503[var_888] as Array;
      ...
      {
         var _loc2_:Offer = var_503[var_888][var_1584];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_426 || _loc1_.pricingModel == Offer.const_464)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_129 || _loc3_.productType == ProductTypeEnum.const_152)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_887.indexOf(_loc5_) == -1)
                        {
                           var_887.push(_loc5_);
                           var_503.push(new Array());
                        }
                        _loc6_ = var_887.indexOf(_loc5_);
                        (var_503[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_503)
         {
            if(var_1584 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1584] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_888 = var_871.getGridItemIndex(param1.view);
