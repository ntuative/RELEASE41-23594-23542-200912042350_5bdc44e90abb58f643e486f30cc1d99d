package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_828 >= 0 && var_828 < page.offers.length)
            {
               _loc4_ = page.offers[var_828];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++var_1476;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1476);
         }
      }
