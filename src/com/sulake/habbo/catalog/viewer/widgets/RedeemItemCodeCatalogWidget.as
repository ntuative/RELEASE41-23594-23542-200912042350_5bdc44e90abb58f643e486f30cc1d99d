package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_918:IButtonWindow;
      
      private var var_917:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_918 != null)
         {
            var_918.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_917 != null)
         {
            var_917.removeEventListener(WindowKeyboardEvent.const_141,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_918 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_918 != null)
         {
            var_918.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_917 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_917 != null)
         {
            var_917.addEventListener(WindowKeyboardEvent.const_141,windowKeyEventProcessor);
         }
      }
