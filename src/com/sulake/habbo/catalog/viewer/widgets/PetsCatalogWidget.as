package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_402 >= var_301.length)
         {
            return "";
         }
         var petColor:IPetColor = var_301[var_402] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_567[var_1494] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_402 = param1.index;
         if(var_402 < 0 || var_402 > var_301.length)
         {
            var_402 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_1008.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_236,onTextWindowEvent);
         var_1008 = new Map();
         ...
         var_844 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_301 = [];
         var_567 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_844);
               if(_loc11_)
               {
                  var_567 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_567.length)
         {
            _loc12_ = var_567[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_844,_loc12_.id),getRaceLocalizationKey(var_844,_loc12_.id)));
            _loc6_++;
         }
         var_1008.add(var_844,_loc5_);
         ...
         _loc5_ = var_1008.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_1008.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_402 >= 0 && var_402 < var_301.length)
         {
            _loc7_ = var_301[var_402] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_567[var_1494] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_844,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.method_1(AvatarAction.const_277,AvatarAction.const_606);
