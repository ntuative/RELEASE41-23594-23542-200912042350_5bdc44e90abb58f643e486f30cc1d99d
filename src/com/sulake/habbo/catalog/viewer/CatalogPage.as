package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1168:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_841:ICatalogViewer;
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1123) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1168;
            _loc2_.init();
         }
         var_1168.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1168.dispatchEvent(param1);
      }
