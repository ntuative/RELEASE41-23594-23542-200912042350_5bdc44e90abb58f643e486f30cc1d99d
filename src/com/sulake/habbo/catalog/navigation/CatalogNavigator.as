package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2221:String = "magic.pixels";
      
      private var var_2222:String = "catalog.page.club";
      
      private var var_2240:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_226,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.WINDOW_EVENT_DISABLE,deActivateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_205,deActivateScrollbar);
         }
      }
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_70.configuration.getKey("client.credits.embed.enabled","false") == "UseObjectMessageEvent";
         if(false && _loc1_)
         {
      ...
      {
         var_70.openCatalogPage(var_2222,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_247.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_247)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_247.indexOf(_loc6_);
            var_247.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
