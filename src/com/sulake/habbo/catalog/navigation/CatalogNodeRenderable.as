package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1013:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1316:XML;
      
      private static var var_1315:XML;
      ...
      private var var_1314:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1314 == 4294967295)
            {
               var_1314 = _loc1_.color;
            }
            _loc1_.color = const_1013;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1317;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1316) as IWindowContainer;
         }
         else
         {
      ...
      {
         _list = navigator.catalog.windowManager.buildFromXML(var_1315) as IItemListWindow;
         if(_list == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.include;
            }
         }
      }
