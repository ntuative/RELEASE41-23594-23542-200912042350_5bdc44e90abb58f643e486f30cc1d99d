package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1568:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            ...
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_438,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_59.getValue(InventoryCategory.const_717));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_59.getValue(InventoryCategory.const_72));
      }
      ...
      {
         var_201.clubPeriods = param1;
         var_201.clubDays = param2;
         var_201.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_799));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_59.getValue(InventoryCategory.const_153));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1568);
         }
      }
      ...
      {
         return AchievementsModel(var_59.getValue(InventoryCategory.const_330));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_808.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_808.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_59.getValue(InventorySubCategory.const_230));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_499 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_808.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1452 = new IncomingMessages(this);
      ...
      {
         return var_201.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_201.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_59.getValue(InventoryCategory.const_253));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_438,roomSessionEventHandler);
         ...
         var_59.add(InventoryCategory.const_72,_loc3_);
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_499);
         var_59.add(InventoryCategory.const_253,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_59.add(InventoryCategory.const_717,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_499);
         var_59.add(InventoryCategory.const_330,_loc6_);
         var _loc7_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_59.add(InventorySubCategory.const_230,_loc7_);
         ...
         var_59.add(InventoryCategory.const_153,_loc9_);
