package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_428 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_542 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_542.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_542.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_428.removeGridItem(_loc2_.window);
         if(var_293 == _loc2_)
         {
            var_293 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_542.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_428.addGridItem(_loc2_.window);
            var_542.add(param1.id,_loc2_);
            if(var_293 == null)
            {
               selectFirst();
            }
