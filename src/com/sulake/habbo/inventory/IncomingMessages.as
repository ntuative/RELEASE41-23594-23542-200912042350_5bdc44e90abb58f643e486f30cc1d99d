package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_43:IHabboCommunicationManager;
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_28 = param1;
         var_43 = var_28.communication;
         var_43.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_43.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_43.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_43.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_43.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_43.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_43.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_43.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_43.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_43.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_43.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_43.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_43.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_43.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_43.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_43.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_43.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_43.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_43.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_43.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_43.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_43.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_43.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_43.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_43.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_43.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_43.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_43.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_43.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_43.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_43.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_43.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_43.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
      }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_72,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_717);
         _loc2_.refreshViews();
         var_28.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_155)
            {
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_43.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_153);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_28.setInventoryCategoryInit(InventoryCategory.const_330);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_72);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_28.toggleInventorySubPage(InventorySubCategory.const_230);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_28.setInventoryCategoryInit(InventoryCategory.const_253);
      }
