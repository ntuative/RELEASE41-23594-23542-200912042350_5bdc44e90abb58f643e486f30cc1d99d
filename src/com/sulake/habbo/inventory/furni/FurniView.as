package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1571:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param4;
         var_440 = new Map();
         var_440.add(FurniModel.const_41,new FurniGridView(var_92,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         var_440.add(FurniModel.const_42,new FurniGridView(var_92,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = var_92.getGroupItemInIndex(_loc3_,var_441);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_293)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_155)
               {
