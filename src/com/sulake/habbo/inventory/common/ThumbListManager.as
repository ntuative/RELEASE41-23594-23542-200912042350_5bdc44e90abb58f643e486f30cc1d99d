package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_980:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_546 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_546.width;
         var_98 = var_546.height;
         var_981 = param5;
         var_798 = param6;
         var_229 = Math.floor(var_981 / _thumbWidth);
         var_32 = new BitmapData(var_981,var_798);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_464 - 1)
         {
            ...
            var_32.fillRect(new Rectangle(0,0 - var_98,var_32.width,var_98),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_32.width,0 - var_98);
               _loc2_ = new Rectangle(0,0,var_32.width,0 - var_98);
               _loc11_.copyPixels(var_32,_loc2_,new Point(0,0),null,null,true);
               var_32 = _loc11_;
               --var_464;
            }
         }
         if(var_32.height < var_798)
         {
            _loc12_ = new BitmapData(var_32.width,var_798);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_546.width,var_546.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_546.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_546,var_546.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_980 != null)
         {
            _loc1_ = var_980.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_464 = resolveRowCountFromList();
         if(var_464 == 0)
         {
            var_32 = new BitmapData(var_981,var_798);
            return;
         }
         var_32 = new BitmapData(Math.max(var_229 * _thumbWidth,var_981),Math.max(var_464 * var_98,var_798),true,16777215);
         var_32.fillRect(var_32.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_464)
         {
            _loc4_ = 0;
            while(_loc4_ < var_229)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_32.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_98),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_229 && var_32.height < _loc3_.y * var_98)
         {
            _loc2_ = new BitmapData(var_32.width,var_32.height + var_98);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_229 - 1),var_98);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_229 - 1),0,_thumbWidth,var_32.height);
         _loc2_.copyPixels(var_32,_loc4_,new Point(0,var_98),null,null,true);
         _loc4_ = new Rectangle(0,var_98,_thumbWidth * (var_229 - 1),0 - var_98);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,var_98),null,null,true);
         var_32 = _loc2_;
      }
