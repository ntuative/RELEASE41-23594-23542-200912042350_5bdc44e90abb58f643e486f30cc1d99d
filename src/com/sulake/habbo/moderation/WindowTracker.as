package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1249:int = 7;
      
      public static const const_948:int = 3;
      
      public static const const_1232:int = 8;
      
      public static const const_964:int = 5;
      ...
      {
         var_1354 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1354[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1354[param1] = _loc2_;
         }
         return _loc2_;
      }
