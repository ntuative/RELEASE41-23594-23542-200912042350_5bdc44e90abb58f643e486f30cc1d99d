package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_744:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         return Math.round(param1 / const_744) + " years ago";
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_766.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_56.getXmlWindow("user_info"));
            var_766.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ModActionCtrl(var_56,_data.userId,_data.userName),_callerFrame,var_959,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_56,WindowTracker.const_964,_data.userId),_callerFrame,var_959,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new RoomVisitsCtrl(var_56,_data.userId),_callerFrame,var_959,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new SendMsgsCtrl(var_56,_data.userId,_data.userName),_callerFrame,var_959,false,true);
      }
