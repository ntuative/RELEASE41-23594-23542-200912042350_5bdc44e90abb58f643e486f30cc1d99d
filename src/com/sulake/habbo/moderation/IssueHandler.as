package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_385:UserInfoCtrl;
      
      private var var_61:ModerationManager;
      
      private var var_963:UserInfoCtrl;
      
      private var var_154:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.releaseBundle(var_154.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_385 = new UserInfoCtrl(_window,var_61);
         var_963 = new UserInfoCtrl(_window,var_61);
         var_385.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_154.getHighestPriorityIssue().reporterUserId);
         var _loc3_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_963.load(_loc3_,var_154.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_154.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_154.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_154.getHighestPriorityIssue().issueId;
         var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_61,WindowTracker.const_948,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_61 != null && false && var_154 != null)
         {
            var_61.issueManager.removeHandler(var_154.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_385 = new UserInfoCtrl(_window,var_61);
            var_385.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_154.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_154.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1232;
      }
   }
}
