package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1373:IMessageComposer;
      ...
      {
         var_729 = IWindowContainer(var_56.getXmlWindow("chatlog_roomheader"));
         var_728 = IWindowContainer(var_56.getXmlWindow("chatlog_chatline"));
         ...
         var_56.connection.send(var_1373);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_729.clone());
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = var_1108[param2.chatterId] != null ? (!!param3 ? 4293570819 : uint(4294955520)) : (!!param3 ? 4288861930 : uint(4294967295));
