package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1554:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1553:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1346:IIssueBrowserView;
      
      private const const_1570:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1552:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_216:ITabContextWindow;
      
      private var var_1347:PickedIssuesView;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1552:
               if(var_1346 == null)
               {
                  var_1346 = new MyIssuesView(issueManager,this,var_216.container);
               }
               return var_1346;
            case const_1554:
               if(var_1345 == null)
               {
                  var_1345 = new OpenIssuesView(issueManager,this,var_216.container);
               }
               return var_1345;
            case const_1553:
               if(var_1347 == null)
               {
                  var_1347 = new PickedIssuesView(issueManager,this,var_216.container);
               }
               return var_1347;
            default:
               return null;
