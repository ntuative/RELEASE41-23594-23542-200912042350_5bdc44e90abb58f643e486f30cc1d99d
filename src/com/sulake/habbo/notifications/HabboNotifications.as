package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1034:String = "badges";
      
      private static const const_1030:String = "pixelbalance";
      
      private static const const_1031:String = "credits";
      
      private static const const_1029:String = "inventory";
      
      private static const const_1033:String = "friendlist";
      
      private static const const_1032:String = "selectfurni";
      
      private static const const_1035:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_522:ParkBusDialogManager;
      
      private var var_1119:IHabboToolbar;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_741);
         }
         var _loc6_:Map = var_741["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_918)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1250);
         }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1203);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1715)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_850);
            var_1715 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1050.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_926,_loc5_);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_522 == null)
         {
            var_522 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_522 != null)
         {
            var_522.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_929.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1050.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_499);
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_187 || param2.type == WindowEvent.const_534)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc16_ = var_499.getProductData(_loc15_.productType);
               _loc17_ = var_499.getFurnitureData(_loc15_.furniClassId);
               _loc7_ = var_499.getProductData(_loc4_.localizationId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_850,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1050.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      {
         var_1119 = IHabboToolbar(param2);
         var_1119.events.addEventListener(HabboToolbarEvent.const_78,method_9);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_188);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_499.userId == _loc2_.userId)
         {
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_293;
            }
            if(param2 == 4057)
            {
      ...
      public function method_9(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_78)
         {
            Logger.log("Notifications: starting to respond to notifications");
            var_374 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_741["styles"],var_741["view"],var_1119);
            ...
            var_499.events.addEventListener(BadgeImageReadyEvent.const_121,onBadgeImage);
            var_1119.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
