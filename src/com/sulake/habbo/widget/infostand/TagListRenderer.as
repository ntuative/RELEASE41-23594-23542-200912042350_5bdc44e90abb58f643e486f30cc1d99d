package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1566:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1261 != null && var_1261.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_120);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_799 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_799 += param1.height + const_1566;
            return fit(param1);
         }
         param1.offset(_offsetX,var_799);
         _offsetX += param1.width + const_1567;
         return true;
      }
