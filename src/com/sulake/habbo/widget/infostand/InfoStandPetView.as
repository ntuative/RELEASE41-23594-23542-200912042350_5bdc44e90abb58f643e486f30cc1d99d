package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1557:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1555:String = "level";
      
      private var var_106:IItemListWindow;
      
      private const const_1563:String = "energy";
      
      private var var_1163:Map;
      
      private const const_1559:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1558:uint = 3355443;
      
      private var var_211:IBorderWindow;
      
      private const const_1560:int = 158;
      
      private const const_1562:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_256:PetCommandTool;
      
      private const const_1556:uint = 11184810;
      
      private const const_1561:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_211 != null)
         {
            var_106 = var_211.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_106 == null || var_211 == null || var_65 == null)
         {
            return;
         }
         ...
         var_211.height = NaN;
         _window.width = Math.max(var_211.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         if(var_256 == null)
         {
            var_256 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1163.getValue(var_596) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_256.showWindow(true);
            var_256.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1555,param1.level,param1.levelMax);
         updateStateElement(const_1561,param1.experience,param1.experienceMax);
         updateStateElement(const_1563,param1.energy,param1.energyMax);
         updateStateElement(const_1559,param1.nutrition,param1.nutritionMax);
         showButton("pick",param1.method_3);
         showButton("train",param1.method_3);
         showButton("kick",param1.canOwnerBeKicked);
         updateRespectButton();
         updateWindow();
         var_596 = param1.id;
         var_1163.remove(param1.id);
         var_1163.add(param1.id,param1);
         if(var_256 && var_256.isVisible() && param1.method_3)
         {
            var_256.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_256.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_413,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1560,const_1562,false);
