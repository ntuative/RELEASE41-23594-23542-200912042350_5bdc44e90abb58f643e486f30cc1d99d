package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_347,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_56,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_347,onObjectUpdate);
         ...
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_56,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_468:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_347:
               if(!var_233)
               {
                  return;
               }
      ...
      private function onEcotronUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_56:
               hideInterface();
         }
      }
      ...
      {
         var _loc1_:* = null;
         if(var_233 || var_156 == -1 || !_controller)
         {
            return;
         }
         var_233 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_530,var_156);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1011,const_1010,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_200 != null)
         {
            _loc4_.caption = var_200;
         }
