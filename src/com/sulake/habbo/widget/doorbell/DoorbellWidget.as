package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1078:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_595,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_104,onDoorbellRejected);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_595,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_104,onDoorbellRejected);
      }
