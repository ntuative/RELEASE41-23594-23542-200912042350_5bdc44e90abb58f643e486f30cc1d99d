package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_475:int = 6;
      
      private static const const_332:int = 10;
      
      private static const const_990:Number = 18;
      
      private static const const_1347:Number = 10;
      
      private static const const_1348:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_879,var_878,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_879,var_878,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1054 = param1.chatType;
         var_879 = param1.userId;
         var_704 = param1.userName;
         var_878 = param1.userCategory;
         _message = param1.text;
         var_1053 = param1.userX;
         var_186 = param1.userImage;
         var_880 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_186 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_358 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_880 != 0)
            {
               _loc31_ = uint(var_880 >> 16 & 255);
               _loc32_ = uint(var_880 >> 8 & 255);
               _loc33_ = uint(var_880 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1054 == RoomWidgetChatUpdateEvent.const_232)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_704);
            }
            else if(var_1054 == RoomWidgetChatUpdateEvent.const_267)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_704);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_358;
            _loc20_.width = _loc20_.textWidth + const_475;
            _width += _loc20_.textWidth + const_475;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_332 + _loc20_.textWidth + const_475;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_879,var_878,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_879,var_878,_roomId,_roomCategory,param1);
      }
