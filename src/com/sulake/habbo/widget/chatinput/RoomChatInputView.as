package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1365:int = 5;
      
      private static const const_475:int = 16;
      ...
      private var var_384:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1964 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1966 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_661 = new Timer(1000,1);
         var_661.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_811 = new Timer(5000,1);
         var_811.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_236,onInputChanged);
         _window.addEventListener(WindowEvent.const_389,onWindowMoved);
         var_1230 = true;
         var_136 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1965 = _loc2_.width + const_475 + _loc6_.width + const_1074;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1075,_loc8_.width) + const_475);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_384);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_384);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_470);
