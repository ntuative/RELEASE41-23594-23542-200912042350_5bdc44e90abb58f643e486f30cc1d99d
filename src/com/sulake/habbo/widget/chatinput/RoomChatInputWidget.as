package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements ICoreUpdateReceiver
   {
      ...
      private static const const_1079:int = 3000;
      
      private static const const_1081:int = 30000;
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         checkForFlooding();
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_525,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_649,onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_192,onUserInfo);
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_683,onSettings);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_898:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1260:
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_649,onChatInputUpdate);
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_683,onSettings);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_398 > const_1080)
         {
            if(_loc1_ < var_1246 + const_1079)
            {
               var_826 = true;
               var_671 = const_1081 / 1000;
               Logger.log("Enabling flood blocking");
               var_827 = new Timer(1000,var_671);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_667,_visualization.window);
         if(messageListener != null)
         {
