package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_733:IWindow;
      
      private var var_735:IWindow;
      
      private var var_384:Number;
      
      private var var_734:ITextWindow;
      
      private var var_167:IWidgetAvatarEffect;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_733 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_167.duration);
               var_733.width = _loc2_ * var_384;
            }
            else
            {
               var_733.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_735 = _window.findChildByName("effect_hilite");
            var_735.visible = false;
         }
         var_734 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_733 = _window.findChildByName("loader_bar");
         if(var_733 != null)
         {
            var_384 = var_733.width;
            var_179.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_167.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_734 != null)
         {
            var_734.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_734.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
