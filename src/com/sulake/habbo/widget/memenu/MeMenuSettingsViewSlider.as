package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_744:MeMenuSettingsView;
      
      private var var_2241:int;
      
      private var var_523:BitmapData;
      
      private var var_933:Number = 1;
      
      private var var_1355:int;
      
      private var var_617:Number = 0;
      ...
      {
         if(param1.type != WindowEvent.const_389)
         {
            return;
         }
         var_744.saveVolume(getValue(param2.x),false);
      }
      ...
      {
         return param1 / var_1355 * (var_933 - var_617) + var_617;
      }
   }
}
