package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1432:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1501:String = "_TEMP";
      ...
      protected var var_1301:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1302:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1042,var_1043);
         var_873 = new Dictionary();
         var_1302 = new Dictionary();
         ParamCodeTable.fillTables(var_873,var_1302);
         var_1301 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1302)
            {
               delete var_1302[_loc1_];
            }
            var_1301.dispose();
            var_1301 = null;
            _context = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         background = parseAttribute(xml,"background",variables,background.toString()) == "UseObjectMessageEvent";
         treshold = uint(parseAttribute(xml,"treshold",variables,treshold.toString()));
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "UseObjectMessageEvent";
         clipping = parseAttribute(xml,"clipping",variables,clipping.toString()) == "UseObjectMessageEvent";
