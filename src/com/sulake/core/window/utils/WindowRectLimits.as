package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         return var_382 == int.MIN_VALUE && var_384 == int.MAX_VALUE && var_383 == int.MIN_VALUE && var_381 == int.MAX_VALUE;
      }
      ...
      {
         var_382 = param1;
         if(var_382 > int.MIN_VALUE && true && _target.width < var_382)
         {
            _target.width = var_382;
         }
      }
      ...
      {
         var_383 = param1;
         if(var_383 > int.MIN_VALUE && true && _target.height < var_383)
         {
            _target.height = var_383;
         }
      }
