package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_578 * maxScrollH,var_350 * maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_206)
         {
            if(param2.type == WindowNotifyEvent.const_257)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_227,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1298,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_356,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_227,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_356,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_227,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_87,true));
         ...
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_227,false));
         ...
         _loc1_.push(new PropertyStruct("margin_left",var_74.left,PropertyStruct.const_87,true));
         _loc1_.push(new PropertyStruct("margin_top",var_74.top,PropertyStruct.const_87,true));
         _loc1_.push(new PropertyStruct("margin_right",var_74.right,PropertyStruct.const_87,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_74.bottom,PropertyStruct.const_87,true));
         _loc1_.push(new PropertyStruct("auto_size",var_495,PropertyStruct.const_227,var_495 != TextFieldAutoSize.NONE));
