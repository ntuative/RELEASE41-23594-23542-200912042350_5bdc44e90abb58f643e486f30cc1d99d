package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1000:String = "increment";
      
      private static const const_476:String = "slider_bar";
      
      private static const const_1001:String = "decrement";
      ...
      protected var var_1512:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0, param13:IScrollableWindow = null)
      {
         ...
         var_35 = param13;
         _horizontal = param3 == WindowType.const_428;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.name)
            {
               case ScrollbarController.const_476:
      ...
      {
         return track.getChildByName(ScrollbarController.const_476) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_709 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_709 != null)
         {
            _loc1_ = findParentByName(var_709) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_709) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1000)
            {
               if(var_35)
               {
                  var_501 = true;
            ...
            else if(param2.name == ScrollbarController.const_1001)
            {
               if(var_35)
               {
                  var_501 = true;
            ...
            else if(param2.name == ScrollbarController.const_727)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_476).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_963)
         {
