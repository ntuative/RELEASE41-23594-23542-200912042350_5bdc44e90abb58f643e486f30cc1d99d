package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1002:String = "_TITLE";
      
      private static const const_1021:String = "_CONTENT";
      
      private static const const_1020:String = "_HEADER";
      
      private static const const_1019:String = "_SCALER";
      ...
      private var var_1099:IHeaderWindow;
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_185);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_185,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_185,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1099 == null)
         {
            var_1099 = findChildByTag(const_1020) as IHeaderWindow;
            if(!var_1099)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1002) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1019) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1300 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_1021) as IWindowContainer;
            if(!var_33)
            {
