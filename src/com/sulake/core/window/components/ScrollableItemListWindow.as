   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_344)
         {
            ...
            if(var_344)
            {
               var_344.addEventListener(WindowEvent.const_226,scrollBarEventProc);
               var_344.addEventListener(WindowEvent.const_205,scrollBarEventProc);
            }
         }
         return var_344;
      }
      ...
      override public function dispose() : void
      {
         if(var_344)
         {
            var_344.removeEventListener(WindowEvent.const_226,scrollBarEventProc);
            var_344.removeEventListener(WindowEvent.const_205,scrollBarEventProc);
            var_344 = null;
         }
         if(_cachedItemList)
         {
