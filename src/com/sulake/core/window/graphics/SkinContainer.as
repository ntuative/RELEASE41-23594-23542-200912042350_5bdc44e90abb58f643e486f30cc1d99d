package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1057:uint = 8;
       
      
      private var var_455:Dictionary;
      
      private var var_1861:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1862 = new Dictionary();
         TypeCodeTable.fillTables(var_1407,var_1862);
         var_1176 = new Dictionary();
         var_1861 = new Dictionary();
         StateCodeTable.fillTables(var_1176,var_1861);
         var_455 = new Dictionary();
         var_455["skin"] = BitmapSkinRenderer;
         var_455["bitmap"] = BitmapDataRenderer;
         var_455["fill"] = FillSkinRenderer;
         var_455["text"] = TextSkinRenderer;
         var_455["shape"] = ShapeSkinRenderer;
         var_455["unknown"] = SkinRenderer;
         var_455["null"] = NullSkinRenderer;
         if(var_355 == null)
         {
            var_355 = new Array();
            var_355.push(WindowState.const_59);
            var_355.push(WindowState.const_66);
            var_355.push(WindowState.const_83);
            var_355.push(WindowState.const_44);
            var_355.push(WindowState.const_75);
            var_355.push(WindowState.const_70);
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1407[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_545[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_545[param1] = new Array(SkinContainer.const_1057);
         }
         var_545[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_545[_loc1_]).dispose();
