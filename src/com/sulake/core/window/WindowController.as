package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      private static var var_1321:Point = new Point();
      ...
      protected var var_577:Function;
      ...
      protected var var_491:uint;
      
      protected var var_30:IGraphicContext;
      
      protected var var_303:Boolean;
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_103,WindowParam.const_147);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
      ...
      {
         if(_state == WindowState.const_394)
         {
            return true;
         }
         _state = WindowState.const_394;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_940,this,null);
         update(this,_loc1_);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1610 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_409:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_493:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_87 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_444,this,null));
         }
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_781,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_22,WindowRedrawFlag.const_824);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_900 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_274,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_491);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_775;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_257:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_375,this,null));
                     if(testParamFlag(WindowParam.const_154,WindowParam.const_149))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_158,WindowParam.const_147))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        _loc8_ = uint(var_31);
                        var_31 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_442))
                        {
                           var_23.width += 0 - 0;
                        }
                        ...
                        var_31 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_246,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_432:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_360);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_976,this,null));
                     if(var_23 != null)
                     {
               ...
               case WindowNotifyEvent.const_308:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_493,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_206,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_392:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_778);
                  break;
               case WindowNotifyEvent.const_444:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_409:
                  if(!(var_31 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_360);
                     }
                  }
                  else if(var_31 & 0)
                  {
               ...
               case WindowNotifyEvent.const_206:
                  ...
                  break;
               case WindowNotifyEvent.const_375:
                  var_23.getRegionProperties(null,var_279);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_274:
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_795;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         return var_577 != null ? var_577 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function maximize() : Boolean
      {
         ...
         setStateFlag(WindowState.const_59,true);
         _loc1_.type = WindowNotifyEvent.const_792;
         update(this,_loc1_);
         return true;
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_491);
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_552;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_900 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_31 & 0);
            if(_loc7_ == WindowParam.const_414)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_863,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_257,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1131,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_59,true);
         _loc1_.type = WindowNotifyEvent.const_1316;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_303 && var_491 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1321,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1321,param3,param1)) : false;
            }
         }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_31 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_409,this,null));
         }
      }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc9_:Boolean = getParamFlag(WindowParam.const_58);
         _loc1_ = 0;
         while(_loc1_ < _loc8_)
         {
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_279 = var_23.rectangle.clone();
               var_60.x = var_22.x;
               var_60.y = var_22.y;
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_373,this,var_23));
            }
            else
            {
               var_279.x = 0;
               ...
               var_279.width = 0;
               var_279.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_931,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_239,_type,var_87,var_31,_context,var_22,null,var_577,properties,var_580.concat(),_id) as WindowController;
         _loc2_.var_491 = var_491;
         _loc2_.var_303 = var_303;
         _loc2_.var_863 = var_863;
         _loc2_.var_279 = var_279.clone();
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_686;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_579;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_491 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_890,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
