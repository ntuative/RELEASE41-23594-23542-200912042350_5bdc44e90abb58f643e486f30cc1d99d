   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_934 = BitmapDataAsset(param1).var_934;
            var_935 = BitmapDataAsset(param1).var_935;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_934 = _loc4_ == "1" || _loc4_ == "UseObjectMessageEvent";
                  break;
               case "flipV":
                  var_935 = _loc4_ == "1" || _loc4_ == "UseObjectMessageEvent";
                  break;
            }
            _loc2_++;
         }
