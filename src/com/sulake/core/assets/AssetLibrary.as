package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_949:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_529:uint = 0;
      
      public static const const_1281:String = "AssetLibraryReady";
      
      public static const const_1159:String = "AssetLibraryUnloaded";
      
      public static const const_419:String = "AssetLibraryLoaded";
      
      public static const const_1138:String = "AssetLibraryLoadError";
       
      
      private var var_445:XML;
      ...
      private var var_444:Boolean = true;
      
      private var var_329:Class;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_445 = _loc2_.manifest.copy();
         var_329 = _loc2_.resource;
         if(var_444)
         {
            AssetLibrary.fetchLibraryContents(this,var_445,var_329);
         }
         var_288 = true;
         dispatchEvent(new Event(AssetLibrary.const_419));
         if(var_444)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_903,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_955,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_937,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_879,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_949.splice(var_949.indexOf(this),1);
            --var_529;
            var_377 = null;
            var_629 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_328.length ? getAssetByName(var_328[param1]) : null;
      }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         if(_file == param1.url && var_288)
         {
            ...
            var_444 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1281));
         }
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_863);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_445.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_329[param1]);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_328.splice(var_328.indexOf(_loc2_),1);
      ...
      {
         return var_329 != null ? false : false;
      }
   }
}
