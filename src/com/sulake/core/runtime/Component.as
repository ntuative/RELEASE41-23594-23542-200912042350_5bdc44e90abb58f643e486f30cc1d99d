package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1256:uint = 4;
      ...
      protected var var_1033:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_860:String = "";
      ...
      protected var var_364:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_1803:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_860 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_860);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1033 & const_1256)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_364 + "]";
      }
   }
}
